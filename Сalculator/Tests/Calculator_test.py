...
class MyTestCase(unittest.TestCase):
    def test_plus(self):
        self.assertEqual(calculator_test('2+2'), ['will be:', 4])  # add assertion here

    def test_minus(self):
        self.assertEqual(calculator_test('71-98'), ['will be:', -27])

    def test_multi(self):
        self.assertEqual(calculator_test('1234*98'), ['will be:', 120932])

    def test_divide(self):
        self.assertEqual(calculator_test('14/3'), ['will be:', 4.666666666666667])
